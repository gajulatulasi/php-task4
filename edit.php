...
// Authorization check - user can only edit their own posts unless admin
...
<div class="container">
  ...
  <div class="card p-4">
    ...
    <form method="POST">
      ...
      <div class="mb-3">
        <textarea class="form-control mb-3" name="content" required minlength="10"><?= htmlspecialchars($post['content']) ?></textarea>
